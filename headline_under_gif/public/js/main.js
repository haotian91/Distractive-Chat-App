				...
				for(i=0;i<5;i++){
	                ...
	                // for(p=0;p<=gifWindow;p++){
			                function moves0 (){
			                    ...
			                    var lefts0 =mw0.left;
			                    var tops0 = mw0.top;
			                    if ((lefts0>=($(window).width()-$("#moveWindow0").width()))||(lefts0<=0))
			                    {
			                        x0=-x0;
			                    }
			                    if ((tops0>=($(window).height()-$("#moveWindow0").height()))||(tops0<=0))
			                    {
			                        y0=-y0;
			                    }
			                    lefts0+=x0;
			                ...
			                function moves1 (){
			                    ...
			                    var lefts1 =mw1.left;
			                    var tops1 = mw1.top;
			                    if ((lefts1>=($(window).width()-$("#moveWindow1").width()))||(lefts1<=0))
			                    {
			                        x1=-x1;
			                    }
			                    if ((tops1>=($(window).height()-$("#moveWindow1").height()))||(tops1<=0))
			                    {
			                        y1=-y1;
			                    }
			                    lefts1-=x1;
			                ...
			                function moves2 (){
			                    ...
			                    var lefts2 =mw2.left;
			                    var tops2 = mw2.top;
			                    if ((lefts2>=($(window).width()-$("#moveWindow2").width()))||(lefts2<=0))
			                    {
			                        x2=-x2;
			                    }
			                    if ((tops2>=($(window).height()-$("#moveWindow2").height()))||(tops2<=0))
			                    {
			                        y2=-y2;
			                    }
			                    lefts2-=x2;
			                ...
			                function moves3 (){
			                    ...
			                    var lefts3 =mw3.left;
			                    var tops3 = mw3.top;
			                    if ((lefts3>=($(window).width()-$("#moveWindow3").width()))||(lefts3<=0))
			                    {
			                        x3=-x3;
			                    }
			                    if ((tops3>=($(window).height()-$("#moveWindow3").height()))||(tops3<=0))
			                    {
			                        y3=-y3;
			                    }
			                    lefts3+=x3;
			                ...
			                function moves4 (){
			                    ...
			                    var lefts4 =mw4.left;
			                    var tops4 = mw4.top;
			                    if ((lefts4>=($(window).width()-$("#moveWindow4").width()))||(lefts4<=0))
			                    {
			                        x4=-x4;
			                    }
			                    if ((tops4>=($(window).height()-$("#moveWindow4").height()))||(tops4<=0))
			                    {
			                        y4=-y4;
			                    }
			                    lefts4+=x4;
					...
					$('#moveWindow'+gifWindow).append('<img src="'+ gif +'" >');
					var objDiv = document.getElementById("texts");
